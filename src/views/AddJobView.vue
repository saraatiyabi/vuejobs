            ...
            <div class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                <form @submit.prevent="handleSubmit">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="type" name="type" class="border rounded w-full py-2 px-3" v-model="state.type"
                            required>
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="state.title" type="text" id="name" name="name"
                            class="border rounded w-full py-2 px-3 mb-2" placeholder="eg. Beautiful Apartment In Miami"
                            required />
                    </div>
                    <div class="mb-4">
                        <label for="description" class="block text-gray-700 font-bold mb-2">Description</label>
                        <textarea v-model="state.description" id="description" name="description"
                    ...
                    <div class="mb-4">
                        ...
                        <select v-model="state.salary" id="salary" name="salary" class="border rounded w-full py-2 px-3"
                            required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="location" name="location" class="border rounded w-full py-2 px-3 mb-2"
                            placeholder="Company Location" v-model="state.location" required />
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="state.company.name" type="text" id="company" name="company"
                    ...
                    <div class="mb-4">
                        <label for="company_description" class="block text-gray-700 font-bold mb-2">Company
                            Description</label>
                        <textarea v-model="state.company.description" id="company_description"
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="state.company.contactEmail" type="email" id="contact_email" name="contact_email"
                    ...
                    <div class="mb-4">
                        ...
                        <input v-model="state.company.contactPhone" type="tel" id="contact_phone" name="contact_phone"
